...
def getExifDateFrom(file: str) -> dt.datetime:
    with ExifToolHelper() as et:
        date = et.get_tags(file, "EXIF:DateTimeOriginal")[0]["EXIF:DateTimeOriginal"]
        # img = Image.open(file)
        ...
        #     raise Exception(f"Sorry, image {file} has exif data but it's creation date value is not present")
        # else:
